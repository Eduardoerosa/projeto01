...
#botao Salvar edição
botao_salvar_frameedicao=customtkinter.CTkButton(frame_de_editar, text="Salvar", width=80, fg_color=("black"),
 hover_color="green",command=lambda : editar_produto(ctk_entry_nome_do_produto_frameeditar.get() , ctk_entry_editarvalor_frameeditar.get() , textbox_editar_nome_frameeditar.get("1.0", "end-1c")))
